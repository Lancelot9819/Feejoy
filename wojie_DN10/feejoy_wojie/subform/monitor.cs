...
namespace feejoy_wojie.subform
{
    ...
    public partial class monitor : DevExpress.XtraEditors.XtraForm
    {
        ...
        private int PLC_connect_DN10_1()
        {
            try
            {
                DN10_1.ActLogicalStationNumber = 10;
                DN10_1.ActPassword = "";
                returncode = DN10_1.Open();
            }
            catch
            {
            }
        ...
        private int PLC_connect_DN10_2()
        {
            try
            {
                DN10_2.ActLogicalStationNumber = 11;
                DN10_2.ActPassword = "";
                returncode = DN10_2.Open();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN10_1()
        {
            try
            {
                returncode = DN10_1.Close();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN10_2()
        {
            try
            {
                returncode = DN10_2.Close();
            }
            catch
            {
            }
        ...
        private string Read_M1(string data_label)
        {
            ...
            PLC_connect_DN10_1();
            iReturnCode = DN10_1.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN10_1();
            if (iReturnCode == 0)
            {
        ...
        private string Read_D1(string data_label)
        {
            ...
            PLC_connect_DN10_1();
            iReturnCode = DN10_1.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN10_1();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M1(string data_address, string value)
        {
            ...
            PLC_connect_DN10_1();
            iReturnCode = DN10_1.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN10_1();
            if (iReturnCode == 0)
            {
        ...
        private string Write_D1(string data_address, string value)
        {
            ...
            PLC_connect_DN10_1();
            iReturnCode = DN10_1.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN10_1();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Read_M2(string data_label)
        {
            ...
            int[] iData = new int[length];
            PLC_connect_DN10_2();
            iReturnCode = DN10_2.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN10_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
            }
        ...
        private string Read_D2(string data_label)
        {
            ...
            short[] iData = new short[length];
            PLC_connect_DN10_2();
            iReturnCode = DN10_2.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN10_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M2(string data_address, string value)
        {
            ...
            PLC_connect_DN10_2();
            iReturnCode = DN10_2.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN10_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Write_D2(string data_address, string value)
        {
            ...
            PLC_connect_DN10_2();
            iReturnCode = DN10_2.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN10_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private void btn_testdata_Click(object sender, EventArgs e)
        {
            ...
            if (tabControl1.SelectedIndex == 0)      //标准表法
            {
                for (int i = 0; i < 9; i++)
                {
                    ...
                    hang.SubItems.Add(b_time[1].ToString());
