...
namespace feejoy_wojie.subform
{
    ...
    {
        SerialPort sp_do = new SerialPort("COM5", 38400, Parity.Even, 8, StopBits.One);
        ...
        private int PLC_connect_DN32_1()
        {
            try
            {
                DN32_1.ActLogicalStationNumber = 32;
                DN32_1.ActPassword = "";
                returncode = DN32_1.Open();
            }
            catch
            {
            }
        ...
        private int PLC_connect_DN32_2()
        {
            try
            {
                DN32_2.ActLogicalStationNumber = 33;
                DN32_2.ActPassword = "";
                returncode = DN32_2.Open();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN32_1()
        {
            try
            {
                returncode = DN32_1.Close();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN32_2()
        {
            try
            {
                returncode = DN32_2.Close();
            }
            catch
            {
            }
        ...
        private string Read_M1(string data_label)
        {
            ...
            PLC_connect_DN32_1();
            iReturnCode = DN32_1.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN32_1();
            if (iReturnCode == 0)
            {
        ...
        private string Read_D1(string data_label)
        {
            ...
            PLC_connect_DN32_1();
            iReturnCode = DN32_1.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN32_1();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M1(string data_address, string value)
        {
            ...
            PLC_connect_DN32_1();
            iReturnCode = DN32_1.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN32_1();
            if (iReturnCode == 0)
            {
        ...
        private string Write_D1(string data_address, string value)
        {
            ...
            PLC_connect_DN32_1();
            iReturnCode = DN32_1.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN32_1();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Read_M2(string data_label)
        {
            ...
            int[] iData = new int[length];
            PLC_connect_DN32_2();
            iReturnCode = DN32_2.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN32_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
            }
        ...
        private string Read_D2(string data_label)
        {
            ...
            short[] iData = new short[length];
            PLC_connect_DN32_2();
            iReturnCode = DN32_2.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN32_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M2(string data_address, string value)
        {
            ...
            PLC_connect_DN32_2();
            iReturnCode = DN32_2.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN32_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Write_D2(string data_address, string value)
        {
            ...
            PLC_connect_DN32_2();
            iReturnCode = DN32_2.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN32_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private void door_control(bool state)
        {
            byte[] crc;
            byte[] tx_data = new byte[8] { 0x01, 0x05, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 };
            ...
            try
            {
                ...
                if (sp_do.IsOpen)
                {
                    ...
                    tx_data[6] = crc[1];
                    tx_data[7] = crc[0];
                    sp_do.Write(tx_data, 0, tx_data.Length);
                }
                sp_do.Close();
            }
            catch { }
