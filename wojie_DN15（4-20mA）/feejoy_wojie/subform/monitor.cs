...
namespace feejoy_wojie.subform
{
    ...
    {
        database.environment wsd = new environment();
        ...
        private int PLC_connect_DN15_1()
        {
            try
            {
                DN15_1.ActLogicalStationNumber = 15;
                DN15_1.ActPassword = "";
                returncode = DN15_1.Open();
            }
            catch
            {
            }
        ...
        private int PLC_connect_DN15_2()
        {
            try
            {
                DN15_2.ActLogicalStationNumber = 16;
                DN15_2.ActPassword = "";
                returncode = DN15_2.Open();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN15_1()
        {
            try
            {
                returncode = DN15_1.Close();
            }
            catch
            {
            }
        ...
        private int PLC_disconnect_DN15_2()
        {
            try
            {
                returncode = DN15_2.Close();
            }
            catch
            {
            }
        ...
        private string Read_M1(string data_label)
        {
            ...
            PLC_connect_DN15_1();
            iReturnCode = DN15_1.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN15_1();
            if (iReturnCode == 0)
            {
        ...
        private string Read_D1(string data_label)
        {
            ...
            PLC_connect_DN15_1();
            iReturnCode = DN15_1.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN15_1();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M1(string data_address, string value)
        {
            ...
            PLC_connect_DN15_1();
            iReturnCode = DN15_1.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN15_1();
            if (iReturnCode == 0)
            {
        ...
        private string Write_D1(string data_address, string value)
        {
            ...
            PLC_connect_DN15_1();
            iReturnCode = DN15_1.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN15_1();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Read_M2(string data_label)
        {
            ...
            int[] iData = new int[length];
            PLC_connect_DN15_2();
            iReturnCode = DN15_2.ReadDeviceRandom(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN15_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
            }
        ...
        private string Read_D2(string data_label)
        {
            ...
            short[] iData = new short[length];
            PLC_connect_DN15_2();
            iReturnCode = DN15_2.ReadDeviceBlock2(data_label, iNumberOfData, out iData[0]);
            PLC_disconnect_DN15_2();
            if (iReturnCode == 0)
            {
                return iData[0].ToString();
        ...
        public string Write_M2(string data_address, string value)
        {
            ...
            PLC_connect_DN15_2();
            iReturnCode = DN15_2.WriteDeviceRandom(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN15_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private string Write_D2(string data_address, string value)
        {
            ...
            PLC_connect_DN15_2();
            iReturnCode = DN15_2.WriteDeviceBlock2(data_address, iNumberOfData, ref iData[0]);
            PLC_disconnect_DN15_2();
            if (iReturnCode == 0)
            {
                return String.Format("0x{0:x8} [HEX]", iReturnCode);
        ...
        private void monitor_Load(object sender, EventArgs e)
        {
            ...
            Thread e1 = new Thread(new ThreadStart(wsd.open_com));
            e1.Start();

            System.Timers.Timer t_wsd = new System.Timers.Timer();
            t_wsd.Enabled= true;
            t_wsd.Elapsed += new ElapsedEventHandler(wsd_show);
            t_wsd.Interval = 1000;
            t_wsd.Start();
        }

        public  void wsd_show(object a, ElapsedEventArgs e)
        {
            tb_temp.Text = plan_data.temp.ToString().Substring(0, 5);
            tb_hum.Text = plan_data.hum.ToString().Substring(0, 5);
        }
        ...
        {
            //数据库路径
            string constr = @"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + System.Windows.Forms.Application.StartupPath + "\\" + "DB_DN15.accdb";
            OleDbConnection conn = null;
            OleDbDataAdapter adapter = null;
            System.Data.DataTable dt = null;
            //文件路径
            IWorkbook workbook = null;
            string filename = @"C:\DN15\DN15模板文件.xlsx";
            string firsttime = System.DateTime.Now.ToString().Replace(":", "-");
            string savetime = firsttime.Replace("/", "-");
            string storename = @"C:\DN15\DN15 " + savetime + ".xlsx";
            cal_file = storename;
            ...
            plan_data.b1_flow1 = cell_float(dio.EvaluateInCell(sheet1.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b1_flow2 = cell_float(dio.EvaluateInCell(sheet1.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b1_flow3 = cell_float(dio.EvaluateInCell(sheet1.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b2_flow1 = cell_float(dio.EvaluateInCell(sheet2.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b2_flow2 = cell_float(dio.EvaluateInCell(sheet2.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b2_flow3 = cell_float(dio.EvaluateInCell(sheet2.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b3_flow1 = cell_float(dio.EvaluateInCell(sheet3.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b3_flow2 = cell_float(dio.EvaluateInCell(sheet3.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b3_flow3 = cell_float(dio.EvaluateInCell(sheet3.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b4_flow1 = cell_float(dio.EvaluateInCell(sheet4.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b4_flow2 = cell_float(dio.EvaluateInCell(sheet4.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b4_flow3 = cell_float(dio.EvaluateInCell(sheet4.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b5_flow1 = cell_float(dio.EvaluateInCell(sheet5.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b5_flow2 = cell_float(dio.EvaluateInCell(sheet5.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b5_flow3 = cell_float(dio.EvaluateInCell(sheet5.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b6_flow1 = cell_float(dio.EvaluateInCell(sheet6.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b6_flow2 = cell_float(dio.EvaluateInCell(sheet6.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b6_flow3 = cell_float(dio.EvaluateInCell(sheet6.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b7_flow1 = cell_float(dio.EvaluateInCell(sheet7.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b7_flow2 = cell_float(dio.EvaluateInCell(sheet7.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b7_flow3 = cell_float(dio.EvaluateInCell(sheet7.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b8_flow1 = cell_float(dio.EvaluateInCell(sheet8.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b8_flow2 = cell_float(dio.EvaluateInCell(sheet8.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b8_flow3 = cell_float(dio.EvaluateInCell(sheet8.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            plan_data.b9_flow1 = cell_float(dio.EvaluateInCell(sheet9.GetRow(18).GetCell(1)).NumericCellValue, 3);
            plan_data.b9_flow2 = cell_float(dio.EvaluateInCell(sheet9.GetRow(21).GetCell(1)).NumericCellValue, 3);
            plan_data.b9_flow3 = cell_float(dio.EvaluateInCell(sheet9.GetRow(24).GetCell(1)).NumericCellValue, 3);
            ...
            adapter = new OleDbDataAdapter("Select * from DN15", conn);
            ...
            string insert = "insert into DN15 values('" + datatime + "'," + 7 + "," + plan_data.b3_flow1 + "," + plan_data.b3_flow2 + "," + plan_data.b3_flow3 + "," + plan_data.b3_k1 + "," + plan_data.b3_k2 + "," + plan_data.b3_k3 + "," + plan_data.b4_k1 + "," + plan_data.b4_k2 + "," + plan_data.b4_k3 + "," + plan_data.b5_k1 + "," + plan_data.b5_k2 + "," + plan_data.b5_k3 + "," + plan_data.b6_k1 + "," + plan_data.b6_k2 + "," + plan_data.b6_k3 + "," + plan_data.b7_k1 + "," + plan_data.b7_k2 + "," + plan_data.b7_k3 + "," + plan_data.b8_k1 + "," + plan_data.b8_k2 + "," + plan_data.b8_k3 + "," + plan_data.b9_k1 + "," + plan_data.b9_k2 + "," + plan_data.b9_k3 + ")";
        ...
        private void btn_cal_pulse_Click(object sender, EventArgs e)
        {
            ////time1
